...
- **[`ParseFailure`](src/Primitives/ParseFailure.cs)** — the closed conversion-failure vocabulary (`Empty`, `Malformed`, `Duplicate`); adding a member is a deliberate breaking change.
